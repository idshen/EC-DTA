    ...
    class DisplayOptionsPanel : XNAOptionsPanel
    {
        ...
        private void MessageBox_NoClicked(XNAMessageBox messageBox)
        {
            ...
            try
            {
                ...
                {
                    Logger.Log("ÉèÖÃ TSCompatFixDeclined Ê§°Ü£¡·µ»Ø´íÎó: " + ex.Message);
                }
            }
            catch { }
        }
        ...
        private void BtnGameCompatibilityFix_LeftClick(object sender, EventArgs e)
        {
            if (GameCompatFixInstalled)
            {
                try
                {
                    ...
                    Logger.Log("DTA/TI/TS ¼æÈÝÐÔÐÞ¸´³É¹¦Ð¶ÔØ¡£");
                ...
                {
                    Logger.Log("Ð¶ÔØ DTA/TI/TS ¼æÈÝÐÔÐÞ¸´Ê§°Ü¡£´íÎóÏûÏ¢: " + ex.Message);
            ...
            try
            {
                ...
                Logger.Log("DTA/TI/TS ¼æÈÝÐÔÐÞ¸´³É¹¦°²×°¡£");
            ...
            {
                Logger.Log("°²×° DTA/TI/TS ¼æÈÝÐÔÐÞ¸´Ê§°Ü¡£´íÎóÏûÏ¢: " + ex.Message);
        ...
        private void BtnMapEditorCompatibilityFix_LeftClick(object sender, EventArgs e)
        {
            if (FinalSunCompatFixInstalled)
            {
                try
                {
                    ...
                    Logger.Log("FinalSun ¼æÈÝÐÔÐÞ¸´³É¹¦Ð¶ÔØ¡£");
                ...
                {
                    Logger.Log("Ð¶ÔØ FinalSun ¼æÈÝÐÔÐÞ¸´Ê§°Ü¡£´íÎóÏûÏ¢: " + ex.Message);
            ...
            {
                Logger.Log("°²×° FinalSun ¼æÈÝÐÔÐÞ¸´Ê§°Ü¡£´íÎóÏûÏ¢: " + ex.Message);
